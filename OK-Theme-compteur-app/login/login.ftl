            ...
            <form id="kc-form-login" action="${url.loginAction}" method="post" onsubmit="return validateLogin()">
                ...
                <div class="${properties.kcFormGroupClass!} labelInput form__group field">
                    ...
                    <#if usernameEditDisabled??>
                        <input class="form__field" tabindex="1" id="username" class="${properties.kcInputClass!}" name="username" value="${(login.username!'')}" type="text" disabled />
                    <#else>
                        <input class="form__field" tabindex="1" id="username" class="${properties.kcInputClass!}" name="username" value="${(login.username!'')}"  type="text" autofocus autocomplete="off" />
                    </#if>
                </div>

                <div class="${properties.kcFormGroupClass!} labelInput form__group field">
                    <label for="password" class="${properties.kcLabelClass!} form__label">${msg("password")}</label>
                    <input class="form__field" tabindex="2" id="password" class="${properties.kcInputClass!}" name="password" type="password" autocomplete="off" />
                </div>
