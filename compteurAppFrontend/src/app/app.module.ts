...
@NgModule({
  declarations: [
    ...
    PaypalPopUpComponent, HistoryFactureClientComponent, AddFacturePricePopupComponent, FiltreFacturePopupComponent, FactureReiptPopupComponent, SimpleLoaderComponent//alessio
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
